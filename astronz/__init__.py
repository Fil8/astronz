...
class rfinder:
    ...
    def main (self,argv):
        ...
        if args.help:  #rfinder -h 
            self.logger.info('\t ... called for help ...\n')
            parser.print_help()
            ...
            self.logger.info('\t ... cosmo: Cosmological Tools ... \n')
            a = agn.AGN()
            ...
            self.logger.info('\t ... radioHI: Neutral Hydrogen Tools ... \n')

        elif args.agn:
            self.logger.info('\t ... AGN: AGN science Tools ... \n')
